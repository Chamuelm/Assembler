...
/* lineInit: Initialize line structure: returns dynamically
 * allocated pointer */
 ...
 *  separated by white spaces and comma */
 ...
 *  Report errors only if reportError is on */
