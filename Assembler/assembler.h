...
extern const command CPUCommands[];		/* Commands constants table */
 ...
 */
enum addressingType {
	IMMEDIATE = 1, DIRECT = 2, STRUCT_ADD = 4, REGISTER = 8, EMPTY = 16, INVALID_ADD_TYPE = 32
};
